...
public partial class Details : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ImageLooker5Reader.HasRows)
        {
            ...
            if (Image5URL == "")
            {
                OleDbCommand UpdateForNoImage5 = new OleDbCommand("UPDATE [tire_machinery] SET [image_1] = 'images/noimage.gif' WHERE [item_number] = @itemnumber", ImageConnection);
        ...
        if (ImageLooker2Reader.HasRows)
        {
            ...
            if (Image2URL == "")
            {
                OleDbCommand UpdateForNoImage2 = new OleDbCommand("UPDATE [tire_machinery] SET [image_2] = 'images/noimage.gif' WHERE [item_number] = @itemnumber", ImageConnection);
        ...
        if (ImageLooker3Reader.HasRows)
        {
            ...
            if (Image3URL == "")
            {
                OleDbCommand UpdateForNoImage3 = new OleDbCommand("UPDATE [tire_machinery] SET [image_3] = 'images/noimage.gif' WHERE [item_number] = @itemnumber", ImageConnection);
        ...
        if (ImageLooker4Reader.HasRows)
        {
            ...
            if (Image4URL == "")
            {
                OleDbCommand UpdateForNoImage4 = new OleDbCommand("UPDATE [tire_machinery] SET [image_4] = 'images/noimage.gif' WHERE [item_number] = @itemnumber", ImageConnection);
        ...
        OleDbCommand gettitle = new OleDbCommand("Select manufacturer, [size], [style], [type] FROM [tire_machinery] WHERE [item_number] = @itemnumber", ImageConnection);

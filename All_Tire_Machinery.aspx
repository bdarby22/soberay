<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="All_Tire_Machinery.aspx.cs" Inherits="All_Machinery" Title="All Rubber Machinery - New and Used" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            <td style="border-bottom: darkgray 1px dashed" valign="top">
                <asp:Label ID="lblType" runat="server" Font-Bold="True" Font-Size="14px" ForeColor="#8080FF">ALL TIRE MACHINERY</asp:Label><span
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/App_Data/xSobesInventoryx.mdb"
        SelectCommand="SELECT [manufacturer], [quantity], [style], [size], [type], [item_number] FROM [TIRE_MACHINERY] ORDER BY [item_number]">

...
<head id="Head1" runat="server">
    ...
    <title>Soberay and Sons Ltd. | Experts in Rubber Equipment | Rubber Machinery | Tire Equipment | Tire Machinery | Tyre Equipment | Tyre Machinery</title>
...
<meta name="Description" content="Soberay and Sons, Experts in Rubber Equipment, Rubber Machinery, Tire Equipment, Tire Machinery, Tyre Equipment, and Tyre Machinery for more than 40 years." />
<meta name="Keywords" content="rubber,equipment,machinery,extruders,calenders,mixers,mills,tire,tires,tyre,tyres,silicone,inner,tube,rebuilds,spares,parts,soberay,and,sons" /> 
...
<table id="Table_01" width="800" border="0" cellpadding="0" cellspacing="0">
	<tr>
		...
		<td style="height: 10px" width="1">
			<img src="images/spacer.gif" width="1" height="10" alt="rubber equipment machinery"></td>
	</tr>
	<tr>
		<td colspan="19" style="height: 69px">
            <table style="width: 99%">
                <tr>
                    ...
                    <td valign="top">
                        <span>&nbsp; &nbsp; <H1 style="font-size:18px">Rubber Machinery Experts</H1>
                        Tire Machinery / Tyre Machinery<br /></span></td>
                </tr>
            </table>
			</td>
		<td style="height: 69px" width="1">
			<img src="images/spacer.gif" width="1" height="69" alt="rubber equipment machinery"></td>
	</tr>
	<tr>
		<td colspan="19">
			<img src="images/soberay_v2_03.gif" width="800" height="1" alt="rubber equipment machinery"></td>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="1" alt="rubber equipment machinery"></td>
	</tr>
	<tr border="1">
		<td rowspan="36" style="width: 18px" valign="top">
			<img src="images/soberay_v2_04.gif" width="18" height="341" alt="rubber equipment machinery"></td>
        <td rowspan="36" style="width: 348px" valign="top">
                ...
                <table id="Table1" border="0" cellpadding="0" cellspacing="0" width="174">
                    <tr>
                        <td nowrap="nowrap" rowspan="2">
                            <img alt="Rubber Equipment, Rubber Machinery, Rubber Calenders, Rubber Extruders, Hydraulic Presses, Injection Presses, Inner Tube, Rubber Lab Equipment, Rubber Mills, Rubber Mixers, Silicone, Tire Machinery, Rubber Re-Builds, Rubber Liquidations, Rubber Surplus, Tyre Machinery" height="29" src="images/soberay_v2_1_05.gif" width="174" /></td>
                    </tr>
                    <tr>
                    </tr>
                    <tr>
                        <td nowrap="nowrap">
                            <img alt="rubber equipment machinery" height="1" src="images/soberay_v2_1_18.gif" width="174" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <img alt="rubber equipment machinery" height="1" src="images/soberay_v2_1_21.gif" width="174" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <img alt="rubber equipment machinery" height="1" src="images/soberay_v2_1_29.gif" width="174" /></td>
                    </tr>
                    <tr>
                        <td nowrap="nowrap" style="height: 20px">
                            &nbsp; &nbsp;
                    ...
                    <tr>
                        <td nowrap="nowrap" style="height: 1px">
                            <img alt="rubber equipment machinery" height="1" src="images/soberay_v2_1_31.gif" width="174" /></td>
                    </tr>
                    <tr>
                        <td nowrap="nowrap" style="height: 20px">
                            &nbsp; &nbsp;
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <img alt="rubber equipment machinery" height="1" src="images/soberay_v2_1_35.gif" width="174" /></td>
                    </tr>
                    <tr>
                        <td nowrap="nowrap" style="height: 20px">
                            &nbsp; &nbsp;
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <img alt="rubber equipment machinery" height="1" src="images/soberay_v2_1_37.gif" width="174" /></td>
                    </tr>
                    <tr>
                        <td nowrap="nowrap" style="height: 20px">
                            &nbsp; &nbsp;
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <img alt="rubber tire machinery" height="1" src="images/soberay_v2_1_39.gif" width="174" /></td>
                    </tr>
                    <tr>
                        <td nowrap="nowrap" style="height: 20px">
                            &nbsp; &nbsp;
                    ...
                    <tr>
                        <td nowrap="nowrap" style="height: 1px">
                            <img alt="rubber equipment machinery" height="1" src="images/soberay_v2_1_41.gif" width="174" /></td>
                    </tr>
                    <tr>
                        <td nowrap="nowrap" style="height: 20px">
                            &nbsp; &nbsp;
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <img alt="rubber equipment machinery" height="1" src="images/soberay_v2_1_43.gif" width="174" /></td>
                    </tr>
                    <tr>
                        <td nowrap="nowrap" style="height: 20px">
                            &nbsp; &nbsp;
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <img alt="rubber equipment machinery" height="1" src="images/soberay_v2_1_45.gif" width="174" /></td>
                    </tr>
                    <tr>
                        <td nowrap="nowrap" style="height: 20px">
                            &nbsp; &nbsp;
                    ...
                    <tr>
                        <td nowrap="nowrap">
                            <img alt="rubber equipment machinery" height="1" src="images/soberay_v2_1_47.gif" width="174" /></td>
                    </tr>
                    <tr>
                        <td nowrap="nowrap">
                            <img alt="rubber equipment machinery" height="17" src="images/soberay_v2_1_48.gif" width="174" /></td>
                    </tr>
                </table>
            </asp:Panel>
        </td>
		<td rowspan="36" style="width: 8px" valign="top">
			<img src="images/soberay_v2_06.gif" width="8" height="341" alt="rubber equipment machinery"></td>
		<td rowspan="22" width="14">
			<img src="images/soberay_v2_07.gif" width="14" height="197" alt="rubber equipment machinery"></td>
		<td width="135">
...
'soberay_v2_14', new Array('soberay_v2_08', 'images/soberay_v2_08.gif', 'soberay_v2_10', 'images/soberay_v2_10.gif', 'soberay_v2_12', 'images/soberay_v2_12.gif', 'soberay_v2_14', 'images/soberay_v2_14-over.gif'), '', new Array('soberay_v2_08', 'images/soberay_v2_08.gif')); return true;"
				...
				<img name="soberay_v2_08" src="images/soberay_v2_08.gif" width="135" height="25" border="0" alt="rubber equipment machinery"></a></td>
		<td width="142">
			<img src="images/soberay_v2_09.gif" width="1" height="25" alt="rubber equipment machinery"></td>
		<td colspan="5">
...
'soberay_v2_14', new Array('soberay_v2_08', 'images/soberay_v2_08.gif', 'soberay_v2_10', 'images/soberay_v2_10.gif', 'soberay_v2_12', 'images/soberay_v2_12.gif', 'soberay_v2_14', 'images/soberay_v2_14-over.gif'), '', new Array('soberay_v2_10', 'images/soberay_v2_10.gif')); return true;"
				...
				<img name="soberay_v2_10" src="images/soberay_v2_10.gif" width="165" height="25" border="0" alt="rubber equipment machinery"></a></td>
		<td width="2">
			<img src="images/soberay_v2_11.gif" width="1" height="25" alt="rubber equipment machinery"></td>
		<td colspan="3">
...
'soberay_v2_14', new Array('soberay_v2_08', 'images/soberay_v2_08.gif', 'soberay_v2_10', 'images/soberay_v2_10.gif', 'soberay_v2_12', 'images/soberay_v2_12.gif', 'soberay_v2_14', 'images/soberay_v2_14-over.gif'), '', new Array('soberay_v2_12', 'images/soberay_v2_12.gif')); return true;"
				...
				<img name="soberay_v2_12" src="images/soberay_v2_12.gif" width="131" height="25" border="0" alt="rubber equipment machinery"></a></td>
		<td width="1">
			<img src="images/soberay_v2_13.gif" width="1" height="25" alt="rubber equipment machinery"></td>
...
'soberay_v2_14', new Array('soberay_v2_08', 'images/soberay_v2_08.gif', 'soberay_v2_10', 'images/soberay_v2_10.gif', 'soberay_v2_12', 'images/soberay_v2_12.gif', 'soberay_v2_14', 'images/soberay_v2_14-over.gif'), '', new Array('soberay_v2_14', 'images/soberay_v2_14.gif')); return true;"
				...
				<img name="soberay_v2_14" src="images/soberay_v2_14.gif" width="124" height="25" border="0" alt="rubber equipment machinery"></a></td>
		<td rowspan="22" width="6">
			<img src="images/soberay_v2_15.gif" width="6" height="197" alt="rubber equipment machinery"></td>
		<td height="197" rowspan="22" width="22">
			</td>
		<td width="1">
	...
	<tr>
		<td colspan="13" rowspan="3">
			<img src="images/soberay_v2_17.gif" width="558" height="11" alt="rubber equipment machinery"></td>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="4" alt="rubber equipment machinery"></td>
	</tr>
	<tr>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="1" alt="rubber equipment machinery"></td>
	...
	<tr>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="6" alt="rubber equipment machinery"></td>
	</tr>
	<tr>
		<td width="558" height="13" colspan="13">
			<img src="images/spacer.gif" width="558" height="13" alt="rubber equipment machinery"></td>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="13" alt="rubber equipment machinery"></td>
	</tr>
	<tr>
		<td colspan="3" rowspan="3">
            <img src="images/template-v2_preslice_temp_2.gif" width="235" height="21" /></td>
		<td rowspan="17" width="6">
			<img src="images/soberay_v2_22.gif" width="6" height="148" alt=""></td>
		<td width="6" height="148" rowspan="17">
			<img src="images/spacer.gif" width="6" height="148" alt="rubber equipment machinery"></td>
		<td rowspan="17" style="width: 4px">
			<img src="images/soberay_v2_24.gif" width="4" height="148" alt="rubber equipment machinery"></td>
		<td colspan="7" rowspan="3">
			<img src="images/soberay_v2_25.gif" width="307" height="21" alt="rubber equipment machinery"></td>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="1" alt="rubber equipment machinery"></td>
	</tr>
	<tr>
	...
	<tr>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="19" alt="rubber equipment machinery"></td>
	</tr>
	<tr>
		<td width="235" height="112" colspan="3" rowspan="13" valign="top">
            <table style="width: 100%">
                ...
                BorderWidth="1px" Font-Names="Tahoma" Font-Size="8pt" Text="search" OnClick="Button2_Click" ValidationGroup="8" /></asp:Button></td>
                </tr>
                <tr style="font-family: Tahoma">
                    <td colspan="1" style="width: 3px;">
                    </td>
                ...
                <tr style="font-family: Tahoma">
                    ...
                    <td align="center" colspan="2">
                        <span style="font-size: 10pt">Welcome to Soberay and Sons,<br />your rubber machinery experts</span></td>
                </tr>
            </table>
			</td> 
		<!-- In the td tag below, I changed the colspan to 7 from 6 -->
		<td width="364" height="112" colspan="7" rowspan="13" valign="top" style="font-family: Tahoma">
            <table style="width: 100%">
                <tr>
                    <td style="width: 4px">
                    </td>
                    <td>
                        <strong><span style="font-size: 12pt; color: #000000; line-height: 12pt; font-family: Franklin Gothic Medium">
                            Sell us your equipment<br />
                        </span></strong><span style="font-size: 6pt">&nbsp;</span>
                        <br /><span style="color: #000000; font-size: 10pt;">Please send us the <strong>description</strong>
                            and <strong>pictures</strong> of your available machinery. Email us at:<br /> 
                                <a href="mailto:purchasing@soberaysons.com?subject=Item for Sale!">purchasing@soberaysons.com</a>
                               </span></td>
                </tr>
            </table>
		</td> 
		...
		<td rowspan="13" width="1">
			<img src="images/soberay_v2_30.gif" width="1" height="112" alt="rubber equipment machinery"></td> 
		-->
		<!-- Commenting out the table containing name, email, and continue --> 
		<!-- 
		<td width="126" height="112" colspan="3" rowspan="13" valign="top" align="left">
            ...
            -->
            <!-- This is the end of the table containing name and email --> 
            <!-- Below is the span tags containing the continue button --> 
            <!-- 
	...
	<tr>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="20" alt="rubber equipment machinery"></td>
	</tr>
	<tr>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="1" alt="rubber equipment machinery"></td>
	...
	<tr>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="5" alt="rubber equipment machinery"></td>
	</tr>
	<tr>
		<td colspan="3">
			<img src="images/soberay_v2_44.gif" width="235" height="15" alt="rubber equipment machinery"></td>
		<td colspan="7">
			<img src="images/soberay_v2_45.gif" width="307" height="15" alt="rubber equipment machinery"></td>
		<td width="1">
			<img src="images/spacer.gif" width="1" height="15" alt="rubber equipment machinery"></td>
	</tr>
    <tr>
       	<td colspan="16"> 
        <p align="center">Please visit our <asp:HyperLink ID="HyperLink18" runat="server" CssClass="pics" NavigateUrl="~/Company.aspx">Company</asp:HyperLink> page for an announcement of available equipment.</p>
        </td>
    </tr>
	<tr>
		...
		<td style="font-size: 9pt" width="1">
	...
	<tr style="font-size: 8.5pt" width="1">
		<td colspan="3" rowspan="4" valign="top" align="center" style="height: 50px" bordercolor="#000000">
		<!--	<img src="images/spacer.gif" width="1" height="17" alt=""> --> 
		<strong>Soberay & Sons</strong><br>recognized by<br><strong><font color="#3366CC">
		<asp:HyperLink ID="HyperLink19" runat="server" CssClass="pics" NavigateUrl="http://www.tyre-asia.com/index.php?option=com_content&view=article&id=147:rubber-tyre-machinery-experts" target="_blank">Polymers & Tyre Asia</asp:HyperLink></font></strong><br><br> 
		<asp:HyperLink ID="HyperLink20" runat="server" CssClass="pics" NavigateUrl="http://www.tyre-asia.com/index.php?option=com_content&view=article&id=147:rubber-tyre-machinery-experts" target="_blank">
        <img src="images/soberay-asia-cover.gif" width="110" height="159"></asp:HyperLink><br><br>
        <strong>Ryan Soberay</strong> (left) and<br><strong>Ron Soberay</strong> (right) appear<br>on the September-October cover of <strong><asp:HyperLink ID="HyperLink21" runat="server" CssClass="pics" NavigateUrl="http://www.tyre-asia.com/index.php?option=com_content&view=article&id=147:rubber-tyre-machinery-experts" target="_blank">Polymers & Tyre Asia</asp:HyperLink></strong></td>
	</tr>
    <tr style="font-size: 9pt">
        <td colspan="1" rowspan="3" width="200" height="400">
            </td>
        <td width="1">
        </td>
    </tr>
	<tr style="font-size: 9pt">
		<td style="height: 423px" width="1">
    ...
    <tr style="font-size: 9pt">
        <td colspan="3" rowspan="1" width="200" style="height: 18px">
        </td>
        <td align="center" bgcolor="#f0f0f0" colspan="16" rowspan="1" valign="top" width="600" style="height: 18px">
            <span style="font-size: 9pt">Copyright <strong><span style="font-family: Arial">?asp:Label
